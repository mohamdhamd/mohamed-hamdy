...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const actionItems = [
    ...
    },
    {
      ...
      icon: Github,
      action: () => window.open(settings.github_url || 'https://github.com/mohamedhamdy', '_blank'),
    },
    {
      id: 'act-linkedin',
      ...
      icon: Linkedin,
      action: () => window.open(settings.linkedin_url || 'https://linkedin.com/in/mohamedhamdy', '_blank'),
    },
  ];
